...
CROSS_COMPILE="ccache arm-linux-gnueabi-" ARCH=arm make -j8 O=aspeed-g5-dev  -j8 DEVICE_TREE=ast2600-rainier EXT_DTB=$HOME/dev/kernels/misc/u-boot-p10bmc.dtb -s && size aspeed-g5-dev/spl/u-boot-spl
